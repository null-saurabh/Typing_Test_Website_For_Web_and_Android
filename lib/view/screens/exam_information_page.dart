          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "$targetExamName Error Calculation",
                  style: const TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.w600,
                      color: Colors.black),
                ...
                RichText(
                  text: const TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text:
                            'The following errors are treated as full mistakes:–',
                        style: TextStyle(
                          fontSize: 20,
                          color: Colors.black,
                        ),
