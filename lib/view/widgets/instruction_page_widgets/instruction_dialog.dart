...
class InstructionDialog extends StatelessWidget {
  ...
  const InstructionDialog({required this.testData,required this.targetExamName,super.key});
    ...
    return Dialog(
      ...
      child: ClipRRect(
        ...
        child: SizedBox(
          ...
          child: InstructionPage(testData: testData,targetExamName: targetExamName,),  // Your current ResultScreen content
        ),
      ),
    );
  }
